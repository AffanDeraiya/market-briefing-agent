...
- [ ] deterministic verifier module + mutations + unit tests
- [ ] LLM semantic layer (live-only, replay-skipped) + FakeBackend tests + Opus-authored prompt
- [ ] schema: optional `verification` surfacing decided (field/event), frontend untouched
- [ ] Gate: tests + eval 100%/100%
